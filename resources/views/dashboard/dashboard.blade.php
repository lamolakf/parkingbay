                    ...
                    <div class="popup_content_body">
                        ...
                        <form id="f1"  enctype="multipart/form-data">
                            ...
                            <div class="formControl half">
                                <label>Bays</label>
                                <input type="number" value="{{$parkingbays[0]->number_of_bays}}"class="inputs" name="bay" id="bay" placeholder="Number of bays" maxlength="100" required>
                            </div>
