...
<html>
            ...
            <sidenav class="h-100">
                <ul class="menu">
                    ...
                    <li class="menu_item" id="dashboard">
                        <a href="#">
                            <div class="menu_img"></div> {{ Auth::user()->name }}</a>
                    </li>
                    <li class="menu_item" id="dashboard">
                    ...
                    <li class="menu_item logout"><a href="{{ route('signout') }}"><i class="fa fa-sign-out" aria-hidden="true"></i>
                       Logout</a></li>
                </ul>
            </sidenav>
            <main>
                ...
                <div class="wrapper">
                    ...
                    <table class="table" id="myTable">
                        ...
                        <tbody>
                            @if($security_guards->count())
                            <?php
                              $edit;
                              
                            ?>
                                @foreach($security_guards as $g)
                                <tr>
                                    <td>{{$g->name}}</td>
                                    <td>{{$g->lastName}}</td>
                                    <td>{{$g->email}}</td>
                                    <td>
                                        <a href="#" onclick="_edit({{$g}})"><i class="fas fa-eye"></i></a> |
                                        <a href="#" onclick="_delete({{$g->id}})"><i class="fas fa-trash"></i></a> 
                                        @if($g->fingerId == null)
                                        |
                                        <a href="#" onclick="addFinger({{$g->id}})"><i class="fas fa-fingerprint"></i></a>
                                        @endif
    ...
    <popup>
        <div class="popup_content">
            ...
            <div class="popup_content_body">
                <h2>Add New Guard</h2>
                <div style="color: red" id="addfeed">
    ...
    <popup>
        <div class="popup_content">
            ...
            <div class="popup_content_body">
                ...
                <div class="wrapper">
                    <center>
                        <svg xmlns="http://www.w3.org/2000/svg" style="height: 100;" viewBox="0 0 512 512"><!--! Font Awesome Pro 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2022 Fonticons, Inc. -->
    ...
    <popup>
        <div class="popup_content" id="edit">
            <div class="popup_content_header" onclick="gEdit()"><i class="fas fa-times"></i></div>
            <div class="popup_content_body">
                <h2>Guard</h2>
                <div style="color: red" id="editfeed">

                </div>
                <form method="PATCH" id="editf1" action="" enctype="multipart/form-data">
                    @csrf
                    <div class="formControl half">
                        <label>Name</label>
                        <input class="inputs" name="id" id="id" placeholder="Name" maxlength="100" hidden>
                        <input class="inputs" name="name" id="name" placeholder="Name" maxlength="100" required>
                    </div>
                    <div class="formControl half">
                        <label>Last Name</label>
...
const firebaseConfig = {
      apiKey: "AIzaSyCcGroZIzoSpfnAxHvKzXdAVWn5_3d2tSw",
      authDomain: "mahlomola-28422.firebaseapp.com",
      databaseURL: "https://mahlomola-28422.firebaseio.com",
      projectId: "mahlomola-28422",
      storageBucket: "mahlomola-28422.appspot.com",
      messagingSenderId: "84290111335",
      appId: "1:84290111335:web:44a1eeffcb830617"
    };
    ...
    function fg() {
        ...
        function addFinger(params)
        {
            ...
            firebase
                ...
                console.log("detection",snapshot.val());
                jQuery('#scan').html("");
                jQuery('#scan').append('<p>' + snapshot.val() + '</p>');

                if(snapshot.val()=="Enrolling Successful")
                {
                    firebase
                .database()
                .ref('done')
        ...
        function gEdit() {
            if (document.getElementsByTagName("popup")[2].style.display == "block") {
                document.getElementsByTagName("popup")[2].style.display = "none";
            } else {
                document.getElementsByTagName("popup")[2].style.display = "block";
            }
        }
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        if (data.hasOwnProperty('success')) {
                            ...
                            jQuery('.alert-success').append('<p>Guard is successfully added</p>');
                            Swal.fire(
                                'Success',
                                'Guard is successfully deleted',
                                'Success'
                            )
                            location.reload(true)
                        };
        ...
        function _edit(params) {
            ...
            $('#edit').find("#id").val(params.id);
            $('#edit').find("#name").val(params.name);
            $('#edit').find("#lastName").val(params.lastName);
            $('#edit').find("#email").val(params.email);
            
        }
        function _delete(params) {
            if(confirm("Your about to delete guard")){
            $.ajax({
                    type: 'POST',
                    url: 'deleteGaurd',
                    data: {
